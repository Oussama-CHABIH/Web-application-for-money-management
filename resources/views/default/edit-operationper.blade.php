...
@section('contenu')
    <section class="content-body" role="main">
        <header class="page-header">
            <h2>Modifier l'opération periodique</h2>
        </header>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h2 class="panel-title">Veuillez saisir les nouvelles informations</h2>
                    </header>
                    <div class="panel-body">
                        <form class="form-horizontal form-bordered" method="post" action="{{ action('OperationperController@posteditoperationper') }}">
                           ...
                           <div class="form-group">
                               ...
                               <label for="inputDefault" class="col-md-1 control-label" >Fréquence</label>
                               <div class="col-md-4">
                                   <input type="text" name="frequence" id="inputDefault" class="form-control" value="{{ $data->frequence }}">
                               </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputDefault" class="col-md-2 control-label">date de début</label>
                                <div class="col-md-4">
                                    <input type="date" name="date_f" id="inputDefault" class="form-control" value="{{ $data->date_d }}">
                                </div>

                                <label for="inputDefault" class="col-md-1 control-label">date de fin</label>
                                <div class="col-md-4">
                                    <input type="date" name="date_f" id="inputDefault" class="form-control" value="{{ $data->date_f }}">
                                </div>
                            </div>
                            
                               
                            <input type="submit" class="btn btn-primary" value="Modifer">
                           <a href="{{ URL::to('/operationpers')}}" class="btn btn-danger">Annuler</a>
